...
export class Feasibility extends Component {
   ...
   ParsePvgisCsv = (obj) => {
    ...
    calculateFeasibility(event) {
        ...
        axios.get(url)
        .then(res => this.setState({feasibilityStudy: res.data}))

        
       // const feasbilityInfo = JSON.parse(this.state.feasibilityStudy);
     //   console.log(feasbilityInfo.outputs);
        this.messages.show({severity: 'info', summary: 'Info Message', detail: 'Done! Click below to see results.'});
                            ...
                            <div className="p-grid">
                                <div className="p-col-6">
                                    <div className="p-grid">
                                        ...
                                        <div className="p-col-6">
                                            <InputText value={this.state.width} style={{width:'100px'}} onChange={(e) => this.setState({width: e.target.value})} rows={1} cols={10}></InputText>
                                        </div>
                                    </div>
                                    <div className="p-grid">
                                        <div className="p-col-6">
                                        ...
                                        <div className="p-col-6">
                                            <InputText value={this.state.height} style={{width:'100px'}} onChange={(e) => this.setState({height: e.target.value})} rows={1} cols={10}></InputText>
                                        </div>
                                    </div>
                                    <div className="p-grid">
                                        <div className="p-col-6">
                                    ...
                                    <div className="p-grid">
                                        ...
                                        <div className="p-col-6">
                                            <InputText value={this.state.buildingFacade} style={{width:'100px'}} onChange={(e) => this.setState({buildingFacade: e.target.value})} rows={1} cols={10}></InputText>
                                        </div>
                                    </div>
                                    <div className="p-grid">
                                        <div className="p-col-6">
                                ...
                                <div className="p-col-6">
                                    <div className="p-vertical">
                                        ...
                                        <div className="p-col-12">
                                            <Button label="Show Results" onClick={this.showFeasbilityResults} aria-controls="overlay_panel" aria-haspopup={true} style={{width: '200px', height: '50px'}} className="p-button-success" />
                                            <OverlayPanel ref={(el) => this.op1 = el} id="overlay_panel" showCloseIcon={true} style={{width: '800px', height: '800px'}}>
                                                <React.Fragment>
