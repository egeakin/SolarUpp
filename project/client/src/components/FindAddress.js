...
export class FindAddress extends Component{
    ...
    componentDidMount(){
        ...
        this.state.userData.geometry.coordinates = [this.state.longitude, this.state.latitude]
    }
    ...
    getLocation() {
        if (navigator.geolocation) {
          navigator.geolocation.getCurrentPosition(this.getCoordinates, this.error, options);
        } else {
    ...
    showInfo() {
        let msg = {severity: 'info', summary: 'Info Message', detail: 'While picking your roof you must first mark up left then up right, then down right and then down left'};
        this.growl.show(msg);
                ...
                <div className="p-col p-fluid p-card">
                    ...
                    <Viewer onClick={(evt) => this.action('Left Click', evt)} ref={e => {this.viewer = e ? e.cesiumElement : null;}}> 
                        ...
                        {this.state.pointPositions.map((item, index) => {
                            ...
                            return(
                                <Entity isPointsClickedEmpty = {false} key={index}
                                    name="test"
                                    description="test!!"
                    ...
                    <div className="p-col card grid">
                        <Card title="Your Roof Results"  subTitle="Details">
                            <div className="p-grid p-fluid dashboard">
                                ...
                                <div className="p-col-12 p-md-6 p-xl-3">
                                    <div className="highlight-box">
                                        <div className="initials" style={{backgroundColor:'#20d077',color:'#038d4a'}}><span>RA</span></div>
                                        <div className="highlight-details ">
                                            <i className="pi pi-search"/>
                                            <span>Roof Area</span>
