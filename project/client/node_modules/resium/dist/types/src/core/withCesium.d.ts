...
export interface CesiumInsideComponentType<E, P = any> extends React.PureComponent<WithContextProps<P, any>> {
    cesiumElement: E;
}
export declare type CesiumHOCComponentType<E, P, C> = React.ForwardRefExoticComponent<React.PropsWithoutRef<P> & React.RefAttributes<CesiumInsideComponentType<E, P>>>;
