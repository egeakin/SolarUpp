...
function (_Component2) {
  ...
  function ContextMenu(props) {
    ...
    _this5.onMenuClick = _this5.onMenuClick.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.onLeafClick = _this5.onLeafClick.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    _this5.onMenuMouseEnter = _this5.onMenuMouseEnter.bind(_assertThisInitialized(_assertThisInitialized(_this5)));
    return _this5;
  }
