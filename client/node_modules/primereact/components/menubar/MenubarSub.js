...
function (_Component) {
  ...
  function MenubarSub(props) {
    ...
    _this.onLeafClick = _this.onLeafClick.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.onChildItemKeyDown = _this.onChildItemKeyDown.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    return _this;
  }
