export declare const polylineEquals: (a: any, b: any) => boolean;
export declare const pickedObjectEquals: (picked: any, element: any) => any;
...
export declare function includes<T>(array: T[] | null | undefined, value: T): boolean;
