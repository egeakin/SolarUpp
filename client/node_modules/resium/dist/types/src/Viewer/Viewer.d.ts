...
export interface ViewerProps extends ViewerCesiumProps, ViewerCesiumReadonlyProps, ViewerCesiumEvents, RootEventProps {
    className?: string;
    id?: string;
...
declare const Viewer: import("../core/component").CesiumComponentType<CesiumViewer, ViewerProps>;
