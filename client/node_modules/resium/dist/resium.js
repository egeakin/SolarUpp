(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('cesium'), require('react-dom')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'cesium', 'react-dom'], factory) :
    (global = global || self, factory(global.Resium = {}, global.React, global.Cesium, global.ReactDOM));
}(this, (function (exports, React, cesium, reactDom) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    var CesiumContext = React.createContext({});
    var Provider = CesiumContext.Provider, Consumer = CesiumContext.Consumer;
    var useCesium = function () { return React.useContext(CesiumContext); };
    ...
    var polylineEquals = function (a, b) {
        return !!a &&
            ...
            a.id === b.id &&
            cesium.DistanceDisplayCondition.equals(a.distanceDisplayCondition,
    ...
    var EventManager = /** @class */ (function () {
        function EventManager(scene) {
            ...
            this.scene = scene;
            this.sshe = new cesium.ScreenSpaceEventHandler((_a = scene) === null || _a === void 0 ? void 0 : _a.canvas);
        }
    ...
    var useCesiumComponent = function (_a, props, ref) {
        ...
        var ctx = useCesium();
        var provided = React.useRef(provide ? {} : undefined);
        var attachedEvents = React.useRef({});
        ...
        var updateProperties = React.useCallback(function (props) {
            var _a;
            if (!element.current)
                return;
            ...
            for (var _i = 0, propDiff_1 = propDiff; _i < propDiff_1.length; _i++) {
                ...
                if (includes(cesiumProps, k)) {
                    ...
                    if (eventHandler instanceof cesium.Event) {
                ...
                if (element.current && cesiumEventProps) {
                    ...
                    for (var _i = 0, _b = Object.keys(initialProps.current); _i < _b.length; _i++) {
                        ...
                        if (eventKey) {
                            ...
                            if (e && eventHandler instanceof cesium.Event) {
    ...
    var createCesiumComponent = function (_a) {
        ...
        var component = function (props, ref) {
            ...
            var wrappedChildren = renderContainer ? (React__default.createElement("div", __assign({ ref: wrapperRef }, (typeof containerProps === "function"
                ? containerProps(mergedProps)
                : pick(mergedProps, containerProps))), children)) : (children);
            if (provided) {
                return React__default.createElement(CesiumContext.Provider, { value: provided }, wrappedChildren);
            }
    ...
    var withCesium = function (Component) {
        return React.forwardRef(function (props, ref) { return (React__default.createElement(Consumer, null, function (value) { return React__default.createElement(Component, __assign({}, props, { ref: ref, cesium: value })); })); });
    };
    ...
    var BillboardCollection = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.BillboardCollection({
    ...
    var BillboardGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.BillboardGraphics({
                image: props.image,
                show: props.show,
                scale: props.scale,
    ...
    var BoxGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.BoxGraphics({
                heightReference: props.heightReference,
    ...
    var Cesium3DTileset = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.Cesium3DTileset(props);
    ...
    var CesiumWidget = createCesiumComponent({
        ...
        create: function (context, props, container) {
            if (!container)
                return;
            var v = new cesium.CesiumWidget(container, pick(props, __spreadArrays(cesiumProps$6, cesiumReadonlyProps$1)));
            if (!v)
                return;
    ...
    var CorridorGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.CorridorGraphics(props);
    ...
    var CustomDataSource = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.dataSourceCollection)
                return;
            var element = new cesium.CustomDataSource(props.name);
            if (props.clustering) {
    ...
    var CylinderGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.CylinderGraphics(props);
    ...
    var CzmlDataSource = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.dataSourceCollection)
                return;
            var element = new cesium.CzmlDataSource(props.name);
            if (props.clustering) {
                element.clustering = props.clustering;
            }
            if (typeof props.show === "boolean") {
    ...
    var EllipseGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.EllipseGraphics(props);
            if (props.classificationType) {
                element.classificationType = props.classificationType;
            }
    ...
    var EllipsoidGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.EllipsoidGraphics(props);
    ...
    var Entity = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entityCollection)
                return;
            var element = new cesium.Entity(props);
    ...
    var EntityDescription = function (_a) {
        ...
        var c = React.useMemo(function () { var _a, _b; return (container !== null && container !== void 0 ? container : (_b = (_a = viewer) === null || _a === void 0 ? void 0 : _a.infoBox.frame.contentDocument) === null || _b === void 0 ? void 0 : _b.createElement("div")); }, [container, viewer]);
        React.useEffect(function () {
            if (!viewer || !entity)
                return;
            var ev = function (e) {
        ...
        return c ? reactDom.createPortal(!container || selected ? children : null, c) : null;
    };
    ...
    var EntityStaticDescription = function (_a) {
        ...
        React.useEffect(function () {
            if (!entity || !children)
                return;
            entity.description = new cesium.ConstantProperty(renderToStaticMarkup(children));
            return function () {
                if (!entity)
                    return;
    ...
    var GeoJsonDataSource = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.dataSourceCollection)
                return;
            var element = new cesium.GeoJsonDataSource(props.name);
            if (props.clustering) {
                element.clustering = props.clustering;
            }
            if (typeof props.show === "boolean") {
    ...
    var GroundPrimitive = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.GroundPrimitive(props);
            if (props.onReady) {
                element.readyPromise.then(props.onReady);
            }
            context.primitiveCollection.add(element);
    ...
    var ImageryLayer = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.imageryLayerCollection)
                return;
            var element = new cesium.ImageryLayer(props.imageryProvider, {
    ...
    var KmlDataSource = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.scene || !context.dataSourceCollection)
                return;
            var element = new cesium.KmlDataSource({
    ...
    var LabelCollection = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.scene || !context.primitiveCollection)
                return;
            var element = new cesium.LabelCollection({
                scene: context.scene,
                modelMatrix: props.modelMatrix,
                blendOption: props.blendOption,
                debugShowBoundingVolume: props.debugShowBoundingVolume,
    ...
    var LabelGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.LabelGraphics(props);
    ...
    var Model = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = props.url ? cesium.Model.fromGltf(props) : new cesium.Model(props);
            if (props.onReady) {
                element.readyPromise.then(props.onReady);
            }
            context.primitiveCollection.add(element);
    ...
    var ModelGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.ModelGraphics(props);
    ...
    var Moon = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.scene)
                return;
            var element = new cesium.Moon(props);
    ...
    var ParticleSystem = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.ParticleSystem(__assign(__assign({}, props), { updateCallback: props.onUpdate }));
            context.primitiveCollection.add(element);
            return element;
        },
    ...
    var PathGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.PathGraphics(props);
    ...
    var PlaneGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.PlaneGraphics(props);
    ...
    var PointGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.PointGraphics(props);
    ...
    var PointPrimitiveCollection = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.PointPrimitiveCollection(props);
            context.primitiveCollection.add(element);
            return element;
        },
        destroy: function (element, context) {
    ...
    var PolygonGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.PolygonGraphics(props);
    ...
    var PolylineCollection = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.PolylineCollection({
                modelMatrix: props.modelMatrix,
                debugShowBoundingVolume: props.debugShowBoundingVolume,
                length: props.length,
                scene: context.scene,
    ...
    var PolylineGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.PolylineGraphics(props);
    ...
    var PolylineVolumeGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.PolylineVolumeGraphics(props);
    ...
    var PostProcessStage = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.scene)
                return;
            var element = new cesium.PostProcessStage(props);
    ...
    var BlackAndWhiteStage = createPostProcessStage({
        ...
        props: ["gradations"],
        create: function () { return cesium.PostProcessStageLibrary.createBlackAndWhiteStage(); },
    });

    var BrightnessStage = createPostProcessStage({
        name: "BrightnessStage",
        props: ["brightness"],
        create: function () { return cesium.PostProcessStageLibrary.createBrightnessStage(); },
    });
    ...
    var LensFlareStage = createPostProcessStage({
        ...
        create: function () { return cesium.PostProcessStageLibrary.createLensFlareStage(); },
    });
    ...
    var NightVisionStage = createPostProcessStage({
        ...
        props: [],
        create: function () { return cesium.PostProcessStageLibrary.createNightVisionStage(); },
    });
    ...
    var PostProcessStageComposite = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.scene)
                return;
            var element = new cesium.PostProcessStageComposite(props);
            if (typeof props.enabled === "boolean") {
                element.enabled = props.enabled;
            }
            if (props.selected) {
    ...
    var BlurStage = createPostProcessStage({
        ...
        create: function () { return cesium.PostProcessStageLibrary.createBlurStage(); },
    });

    var DepthOfFieldStage = createPostProcessStage({
        name: "DepthOfFieldStage",
        props: ["delta", "focalDistance", "sigma", "stepSize"],
        create: function () { return cesium.PostProcessStageLibrary.createDepthOfFieldStage(); },
    });

    var EdgeDetectionStage = createPostProcessStage({
        name: "EdgeDetectionStage",
        props: ["color", "length"],
        create: function () { return cesium.PostProcessStageLibrary.createEdgeDetectionStage(); },
    });

    var SilhouetteStage = createPostProcessStage({
        name: "SilhouetteStage",
        props: ["color", "length"],
        create: function () { return cesium.PostProcessStageLibrary.createSilhouetteStage(); },
    });
    ...
    var Primitive = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.primitiveCollection)
                return;
            var element = new cesium.Primitive(props);
            if (props.onReady) {
                element.readyPromise.then(props.onReady);
            }
            context.primitiveCollection.add(element);
    ...
    var RectangleGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.RectangleGraphics(props);
    ...
    var TimeDynamicPointCloud = createCesiumComponent({
        ...
        create: function (context, props) {
            ...
            if (!context.cesiumWidget || !context.primitiveCollection)
                return;
            var element = new cesium.TimeDynamicPointCloud(__assign(__assign({}, props), { clock: (_a = props.clock, (_a !== null && _a !== void 0 ? _a : (_b = context.cesiumWidget) === null || _b === void 0 ? void 0 : _b.clock)) }));
            if (props.onReady) {
                element.readyPromise.then(props.onReady);
            }
            context.primitiveCollection.add(element);
    ...
    var Viewer = createCesiumComponent({
        ...
        create: function (context, props, wrapper) {
            if (!wrapper)
                return;
            var v = new cesium.Viewer(wrapper, props);
            if (!v)
                return;
    ...
    var WallGraphics = createCesiumComponent({
        ...
        create: function (context, props) {
            if (!context.entity)
                return;
            var element = new cesium.WallGraphics(props);
    ...
    exports.EntityStaticDescription = EntityStaticDescription;
    exports.Fog = Fog;
    exports.Fxaa = Fxaa;
    exports.GeoJsonDataSource = GeoJsonDataSource;
    exports.Globe = Globe;
    exports.GroundPrimitive = GroundPrimitive;
    exports.GroundPrimitiveCollection = GroundPrimitiveCollection;
    ...
    exports.createCameraOperation = createCameraOperation;
    exports.createCesiumComponent = createCesiumComponent;
    exports.eventManagerContextKey = eventManagerContextKey;
    exports.eventNames = eventNames;
    exports.useCesium = useCesium;
    exports.useCesiumComponent = useCesiumComponent;
